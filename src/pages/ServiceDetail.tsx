...
const serviceData: Record<string, {
  ...
  "digital-marketing": {
    ...
    problemHeadline: "Your marketing spend isn't producing predictable growth",
    problemBullets: [
      "Leads arrive in bursts, not consistently",
      "You can't clearly track what's working",
      "Customer acquisition costs keep rising",
      "Decisions are based on guesses, not data",
    ],
    solutionHeadline: "A measurable marketing system built for sustainable growth",
    solutionBullets: [
      "Strategy-first campaign planning",
      "Funnel-based acquisition and retargeting",
  ...
  "marketing-automation": {
    ...
    problemHeadline: "Your team is doing too much manual work",
    problemBullets: [
      "Manual lead handling wastes time",
      "Inconsistent follow-ups reduce conversions",
      "Disconnected tools create errors",
      "Scaling feels chaotic instead of controlled",
    ],
    solutionHeadline: "Automated systems that work in the background",
    solutionBullets: [
      "Automated lead capture & routing",
      "Smart email and CRM workflows",
  ...
  "workflow-automation": {
    ...
    problemHeadline: "Your operations don't scale with your growth",
    problemBullets: [
      "Teams rely on manual processes",
      "Data lives in disconnected systems",
      "Errors slow down execution",
      "Scaling requires more people, not better systems",
    ],
    solutionHeadline: "Connected workflows that eliminate friction",
    solutionBullets: [
      "Automated task handoffs",
      "Tool-to-tool data syncing",
      "Error reduction and alerts",
  ...
  "ai-integration": {
    ...
    problemHeadline: "You're hearing about AI — but don't know how to use it",
    problemBullets: [
      "Unclear where AI actually fits",
      "Tools feel complex and unreliable",
      "No integration with existing systems",
      "Risk of wasting time and budget",
    ],
    solutionHeadline: "Practical AI integrations that create real impact",
    solutionBullets: [
      "AI-powered lead qualification",
      "Smart content and response automation",
