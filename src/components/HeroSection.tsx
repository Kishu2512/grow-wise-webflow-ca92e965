...
const HeroSection = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-primary pt-20 scanlines">
      ...
      <div className="absolute left-[15%] top-0 w-px h-full bg-gradient-to-b from-transparent via-cyan/20 to-transparent opacity-40" />
      <div className="absolute left-[85%] top-0 w-px h-full bg-gradient-to-b from-transparent via-cyan/20 to-transparent opacity-30" />
      <div className="absolute left-[50%] top-0 w-px h-full bg-gradient-to-b from-transparent via-neon-magenta/10 to-transparent opacity-20" />

      {/* Glow orbs */}
      <div className="absolute top-1/3 left-1/4 w-[400px] h-[400px] bg-cyan/10 rounded-full blur-[120px]" />
      <div className="absolute bottom-1/4 right-1/4 w-[300px] h-[300px] bg-neon-magenta/8 rounded-full blur-[100px]" />
      ...
      <div className="section-container relative z-10">
        <div className="max-w-5xl mx-auto text-center">
          ...
          {/* Sub-headline with terminal feel */}
      ...
      {/* Bottom scanline bar */}
      <div className="absolute bottom-0 left-0 right-0 h-px bg-cyan/30" />
    </section>
  );
};
