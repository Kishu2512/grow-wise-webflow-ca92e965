...
const TestimonialsSection = () => {
  const testimonials = [
    {
      quote: "Webflowra transformed our website and lead system. We now get daily leads without manual work.",
      author: "Rahul",
      role: "Business Coach",
      rating: 5,
    },
    {
      quote: "Their automation saved us 20+ hours per week. Highly recommended.",
      author: "Sneha",
      role: "Agency Owner",
      rating: 5,
    },
      ...
      <div className="section-container relative z-10">
        ...
        <div className="grid md:grid-cols-3 gap-5">
          {testimonials.map((testimonial, index) => (
            <div key={index} className="cyber-card p-7 card-hover relative">
              {/* Corner brackets */}
              ...
              <div className="flex items-center gap-3 pt-4 border-t border-white/5">
                <div className="w-10 h-10 rounded flex items-center justify-center bg-cyan/10 border border-cyan/20">
                  <span className="text-cyan font-mono font-bold text-sm">
